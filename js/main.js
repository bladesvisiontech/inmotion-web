(() => {
  ...
  const translations = {
    en: {
      ...
      'hero-sub':'Professional websites + SEO for $700. We build digital assets that generate revenue — fast, mobile-first, and optimized for Google from day one.',
    ...
    es: {
      ...
      'hero-sub':'Sitios web profesionales + SEO por $700. Construimos activos digitales que generan ingresos — rápidos, mobile-first y optimizados para Google desde el primer día.',
